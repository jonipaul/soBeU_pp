...
function sbLoop_0LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = sbLoop_0[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisSbLoop_0 = result.value;
...
function sliders_0LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = sliders_0[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisSlider_0 = result.value;
...
function buffer_0LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = buffer_0[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisBuffer_0 = result.value;
...
function sbLoop_1LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = sbLoop_1[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisSbLoop_1 = result.value;
...
function buffer_1LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = buffer_1[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisBuffer_1 = result.value;
